!function(a, b, c, d){
	/* $ window document */
	function JarvisWidget(b, c) {
		this.obj = a(b),
		this.o = a.extend({},
		a.fn.jarvisWidgets.defaults, c),
	...
	JarvisWidget.prototype = {
		...
		_getPastTimestamp: function(a) {
			...
			var j = b.o.timestampFormat.replace(/%d%/g, e).replace(/%m%/g, d).replace(/%y%/g, "jarvisWidgets").replace(/%h%/g, g).replace(/%i%/g, h).replace(/%s%/g, i);
			return j
		},
	...
	a.fn.jarvisWidgets = function(b) {
		return this.each(function() {
			var c = a(this),
				d = c.data("jarvisWidgets"),
				g = "object" == typeof b && b;
			d || c.data("jarvisWidgets", d = new JarvisWidget(this, g)), "string" == typeof b && d[b]()
		})
	};
	a.fn.jarvisWidgets.defaults = {
		grid: "section",
