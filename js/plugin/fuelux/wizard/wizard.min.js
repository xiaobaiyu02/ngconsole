 /*! SmartAdmin - v1.4.1 - 2014-06-20 */var old = $.fn.wizard, Wizard = function(a, b) {
    var c;
...
Wizard.prototype = {constructor: Wizard,setState: function() {
        ...
        if (this.options.disablePreviousStep && (a = !1), a) {
            var b = $.Event("change");
            if (this.$element.trigger(b, {step: this.currentStep,direction: "previous"}), b.isDefaultPrevented())
                return;
        ...
        if (a) {
            var c = $.Event("change");
            if (this.$element.trigger(c, {step: this.currentStep,direction: "next"}), c.isDefaultPrevented())
                return;
            this.currentStep += 1, this.setState()
        } else
            b && this.$element.trigger("finished")
