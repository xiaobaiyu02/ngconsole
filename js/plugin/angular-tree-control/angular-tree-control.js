        ...
        .directive( 'treecontrol', ['$compile', function( $compile ) {
            ...
            return {
                ...
                controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig', function ($scope, $templateCache, $interpolate, treeConfig) {
                    ...
                    var selectedNodes = [];var expandedNodes = [];
                    if($scope.selectedNodes){
                        $scope.selectedNodes.forEach(function(item){ selectedNodes.push(item) });
                    }
                    if($scope.expandedNodes){
                        $scope.expandedNodes.forEach(function(item){ expandedNodes.push(item) });
                    }
                    ...
                    $scope.selectNodeHead = function() {
                        ...
                        if (expanding) {
                            ...
                            var index;
                            var group = $scope.expandedNodes.filter(function(item){ return item.key=='common' }).slice(1);
                            for(var i=0; i<group.length; i++){
                                $scope.expandedNodes.splice($scope.expandedNodes.indexOf(group[i]),1);
                            }
