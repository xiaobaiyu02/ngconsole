...
angular.module("vdi.webSpice", ["app.localize", "app.controllers", "vdi"]).factory('BrowserConnect', ["$resource", "$Domain", function ($resource, $Domain) {
    ...
    function setIframeParams(host, port, token, password) {
        var p = port || 6082;
        iframe.src = "js/vdi-spice/vdi-client/index.html?host=" + host + "&port=" + p + "&token=" + token + "&password=" + $$base64encode(password);
    }
...
/******/ });
//# sourceMappingURL=webLoginSpice.map