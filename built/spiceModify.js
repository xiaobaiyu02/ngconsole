...
var $instance_id;
angular.module("vdi.spice", ["app.controllers", "app.localize", "ngResource", "ui.bootstrap", "vdi", "vdi.desktop", "vdi.template", "vdi.template.teach", "vdi.template.person", "vdi.template.hardware", "vdi.system", "vdi.user"]).config(["$locationProvider", function ($locationProvider) {
...
}]).controller("spiceController", ["$scope", "VMCommon", "VNC", "TeachTemplate", "PersonTemplate", "SystemISO", "Admin", "PersonDesktop", "$modal", "$timeout", "Scene", "$$$os_types", "UserRole", "$$$I18N", "$$$var_constant", "$$base64encode", function ($scope, vm, vnc, template, personTemplate, iso, admin, desktop, $modal, $timeout, scen, $$$os_types, UserRole, $$$I18N, $$$var_constant, $$base64encode) {
    var flag = false;
...
/******/ });
//# sourceMappingURL=spiceModify.map